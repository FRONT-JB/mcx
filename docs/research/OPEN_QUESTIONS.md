...
- [-] required idempotency의 exact key, scope, retention, duplicate result
      ...
      schema는 여전히 미정
- [x] parallel execution 도입 Gate를 정의한다. → **Phase 11 COMPLETE**. exact Blueprint/AC stage plan,
      ...
      [DOGFOODING_0007](./DOGFOODING_0007.md)). upstream Coordinator 경로를
      채택했고 대표 brownfield 실경로까지 통과했다.
