...
| changed_files 수집 (git 기반) | VerificationArtifacts에 포함 | **해소 2026-08-09** ([ADR-0048](./0048-changed-files-collection.md) Proposed) — 보류의 실질 이유는 비교 기준점 부재였고, checkpoint(0046)·rollback(0047)이 그것을 만들었다. 기준선은 HEAD이며 수집은 검증 명령 실행 전이다 | [ADR-0027](./0027-telemetry-layers-and-v1-schema.md) §1, [ADR-0028](./0028-verify-v1-mechanical-contract.md) §4 |
