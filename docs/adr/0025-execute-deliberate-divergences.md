...
| resume/cancel 계약 | **cancel은 조사·구현 완료** ([MCP findings §5·§9](../research/MCP_UPSTREAM_FINDINGS.md), [ADR-0041](./0041-mcp-control-surface-contract.md) §5). **resume은 미조사 — Phase 9로 재지정** (2026-08-09, Phase 7 종료 검토): 중단 지점 복구는 되돌리기 층과 같은 자리여야 의미가 있다 |
